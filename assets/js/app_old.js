...
(function() {
    ...
    function mostrarPreview(response) {
        ...
        if (convocatoriaInfo) {
            document.getElementById('codigoBasePreview').textContent = convocatoriaInfo.codigo_base;
            document.getElementById('nombreConvPreview').textContent = convocatoriaInfo.nombre;
        }
        ...
        if (codigosInvalidos > 0) {
            ...
            //document.getElementById('opcionesCarga').classList.remove('d-none');
			//} else {
			//	document.getElementById('opcionesCarga').classList.add('d-none');
			//}
